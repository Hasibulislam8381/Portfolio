...
<html lang="en">
    ...
    <body id="page-top">
                ...
                <ul class="timeline">
                    @if(count($abouts)>0)
                        ...
                        <li class="timeline-inverted">
                            <div class="timeline-image "><img class="rounded-circle img-fluid d-block" style="height:100%" src="{{url($about->image)}}"" alt="Cinque Terre" /></div>
        ...
        <footer class="footer py-4">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-4 text-lg-start">Copyright &copy; Hasibul Islam Himel 2022</div>
                    <div class="col-lg-4 my-3 my-lg-0">
                        <a class="btn btn-dark btn-social mx-2" href="https://github.com/Hasibulislam8381?tab=repositories" aria-label="Github"><i class="fa-brands fa-github"></i></a>
                        <a class="btn btn-dark btn-social mx-2" href="https://www.facebook.com/hasibulislam.himel.12/" aria-label="Facebook"><i class="fab fa-facebook-f"></i></a>
                        <a class="btn btn-dark btn-social mx-2" href="https://www.linkedin.com/in/hasibulislam83" aria-label="LinkedIn"><i class="fab fa-linkedin-in"></i></a>
                    </div>
